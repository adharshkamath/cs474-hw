...
\begin{questions}
	...
	To convert to CNF, we use the Tseitin transformation. We only need three new propositional variables, $x_{\neg \psi}, x_1, x_2$,
	where $\neg x_{\psi}$ corresponds to $\neg \psi$, $x_1$ corresponds to $(\neg p \lor q)$ and $x_2$ corresponds to $(p \land x_1)$.
